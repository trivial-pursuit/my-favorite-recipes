	...
	fun openApi(): OpenAPI =
		OpenAPI().apply {
			info = Info().apply {
				...
				description = "A service for saving and managing some yummy recipes"
				version = OpenApiConfig::class.java.`package`.implementationVersion ?: "local"
				contact = Contact().apply {
					name = "My Favorite Recipes"
					url = "https://github.com/trivial-pursuit/my-favorite-recipes"
					email = "my-favorite-recipes@ognibeni.info"
				}}
